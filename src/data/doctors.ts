export type Doctor = {
  ...
  expertise: string[];
  treatments: { i: string; n: string; c: string; href: string }[];
...
export const DOCTORS: Doctor[] = [
  {
    ...
    treatments: [
      { i: "❋", n: "FUE Hair Transplant", c: "Hair Restoration", href: "/procedures/hair-transplant" },
      { i: "❋", n: "DHI Hair Transplant", c: "Hair Restoration", href: "/procedures/hair-transplant" },
      { i: "✦", n: "PRP for Hair Loss", c: "Hair Restoration", href: "/procedures/hair-transplant" },
      // Botox has no plasticSurgeryCategory tag, so it never appears under
      // either tab on /procedures/plastic-surgery — link straight to its
      // own page instead of a tab it would never show up on.
      { i: "◐", n: "Anti-Wrinkle (Botox)", c: "Injectables", href: "/procedures/plastic-surgery/botox" },
      { i: "✶", n: "Cosmelan Protocol", c: "Pigmentation", href: "/concerns" },
      { i: "⟡", n: "Laser Hair Reduction", c: "Lasers", href: "/concerns" },
    ],
    quotes: [
      {
  ...
  },
  {
    ...
    treatments: [
      { i: "✦", n: "Rhinoplasty", c: "Cosmetic Surgery", href: "/procedures/plastic-surgery?category=Aesthetic%20Surgery" },
      { i: "✶", n: "Blepharoplasty", c: "Cosmetic Surgery", href: "/procedures/plastic-surgery?category=Aesthetic%20Surgery" },
      { i: "◐", n: "Facelift", c: "Cosmetic Surgery", href: "/procedures/plastic-surgery?category=Aesthetic%20Surgery" },
      { i: "⟡", n: "Liposuction", c: "Body Contouring", href: "/procedures/plastic-surgery?category=Aesthetic%20Surgery" },
      { i: "❋", n: "Gynecomastia Surgery", c: "Body Contouring", href: "/procedures/plastic-surgery?category=Aesthetic%20Surgery" },
      { i: "◍", n: "Scar Revision", c: "Reconstructive", href: "/procedures/plastic-surgery?category=Reconstructive%20Surgery" },
    ],
    quotes: [
      {
