...
export const structure = (S: StructureBuilder) =>
  S.list()
    ...
    .items([
      ...
      S.documentTypeListItem("bodyConcern").title("Body Concerns"),
      S.documentTypeListItem("equipment").title("Lasers / Technologies"),
      ...
      S.divider(),
      S.documentTypeListItem("realResult").title("🖼️ Real Results (Before/After)"),
